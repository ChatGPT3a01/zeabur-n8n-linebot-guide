...
export default function Part1() {
  const slides = [
    ...
    <Slide key="why-zeabur">
      <h2 className="text-[#2a5298] text-[32px] md:text-[38px] font-bold mb-8 border-b-[3px] border-[#1e3c72] pb-3">🤔 為什麼選擇 Zeabur？</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="bg-gradient-to-br from-[#667eea] to-[#764ba2] text-white p-6 rounded-2xl shadow-lg transform hover:scale-105 transition-all">
          ...
          <h3 className="text-[24px] font-bold mb-3">完全免費開始</h3>
        ...
        <div className="bg-gradient-to-br from-[#f093fb] to-[#f5576c] text-white p-6 rounded-2xl shadow-lg transform hover:scale-105 transition-all">
          <div className="text-[42px] mb-3">⚡</div>
          <h3 className="text-[24px] font-bold mb-3">極速部署</h3>
          <ul className="space-y-2 text-[16px]">
            <li>✅ 一鍵部署 n8n 模板</li>
        ...
        <div className="bg-gradient-to-br from-[#4facfe] to-[#00f2fe] text-white p-6 rounded-2xl shadow-lg transform hover:scale-105 transition-all">
          <div className="text-[42px] mb-3">🔒</div>
          <h3 className="text-[24px] font-bold mb-3">安全可靠</h3>
          <ul className="space-y-2 text-[16px]">
            <li>✅ 自動配置 HTTPS</li>
            <li>✅ 內建域名管理</li>
            <li>✅ 穩定的雲端服務</li>
        ...
        <div className="bg-gradient-to-br from-[#43e97b] to-[#38f9d7] text-white p-6 rounded-2xl shadow-lg transform hover:scale-105 transition-all">
          <div className="text-[42px] mb-3">🎯</div>
          <h3 className="text-[24px] font-bold mb-3">零維護成本</h3>
          <ul className="space-y-2 text-[16px]">
            <li>✅ 無需管理伺服器</li>
            <li>✅ 自動更新與備份</li>
            <li>✅ 專注於開發工作流</li>
      ...
      <div className="bg-[#e8f5e9] border-l-4 border-[#4caf50] p-5 rounded-r-lg">
        <p className="text-[18px] text-[#2e7d32]">
    ...
    <Slide key="dashboard">
      <h2 className="text-[#2a5298] text-[32px] md:text-[38px] font-bold mb-8 border-b-[3px] border-[#1e3c72] pb-3">🎛️ Zeabur 控制台介面導覽</h2>

      <p className="text-[20px] text-[#444] mb-6">登入成功後，你會看到 Zeabur 的控制台 (Dashboard)：</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white p-6 rounded-xl shadow-lg border-t-4 border-[#667eea] transform hover:-translate-y-2 transition-all">
          ...
          <h3 className="text-[22px] font-bold text-[#1e3c72] mb-3">Projects</h3>
          <p className="text-[16px] text-[#666]">管理所有專案，每個專案可包含多個服務（如 n8n、資料庫等）</p>
        </div>

        <div className="bg-white p-6 rounded-xl shadow-lg border-t-4 border-[#f5576c] transform hover:-translate-y-2 transition-all">
          <div className="text-[36px] mb-3">🚀</div>
          <h3 className="text-[22px] font-bold text-[#1e3c72] mb-3">Deploy</h3>
          <p className="text-[16px] text-[#666]">快速部署服務的入口，支援 GitHub、模板等多種方式</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg border-t-4 border-[#43e97b] transform hover:-translate-y-2 transition-all">
          ...
          <h3 className="text-[22px] font-bold text-[#1e3c72] mb-3">Settings</h3>
          <p className="text-[16px] text-[#666]">帳戶設定、團隊管理、計費資訊等</p>
        </div>
      </div>

      <div className="bg-[#fff3cd] border border-[#ffc107] p-5 rounded-xl">
        <p className="text-[18px] text-[#856404]">
    ...
    <Slide key="verify">
      <h2 className="text-[#2a5298] text-[32px] md:text-[38px] font-bold mb-8 border-b-[3px] border-[#1e3c72] pb-3">📱 重要：手機號碼驗證</h2>
      ...
      <div className="bg-[#ffebee] border-l-4 border-[#f44336] p-8 rounded-r-2xl mb-8">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="text-[24px] font-bold text-[#c62828] mb-3">⚠️ 必須完成手機驗證</h3>
            <p className="text-[18px] text-[#d32f2f] leading-relaxed">
      ...
      <div className="bg-white p-8 rounded-2xl shadow-lg border border-[#e0e0e0]">
        <h3 className="text-[26px] font-bold text-[#1e3c72] mb-6 flex items-center gap-2">
          <span className="bg-[#2196f3] text-white w-8 h-8 rounded-full flex items-center justify-center text-[18px]">!</span>
          驗證步驟
        </h3>
    ...
    <Slide key="quota">
      <h2 className="text-[#2a5298] text-[32px] md:text-[38px] font-bold mb-8 border-b-[3px] border-[#1e3c72] pb-3">💸 免費方案額度說明</h2>
      ...
      <div className="bg-gradient-to-r from-[#667eea] to-[#764ba2] text-white p-8 rounded-2xl mb-8 shadow-xl">
        <div className="text-center mb-6">
          ...
          <p className="text-[24px]">每月免費額度（美金）</p>
        </div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-xl shadow-lg">
          <h3 className="text-[22px] font-bold text-green-600 mb-4 flex items-center gap-2">
            ✅ 足夠運行的服務
          </h3>
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg">
          <h3 className="text-[22px] font-bold text-orange-600 mb-4 flex items-center gap-2">
            ⚠️ 注意事項
          </h3>
          <ul className="space-y-3 text-[16px]">
            <li className="flex items-start gap-2">
      ...
      <div className="mt-6 bg-[#e8f5e9] border-l-4 border-[#4caf50] p-5 rounded-r-lg">
        <p className="text-[17px] text-[#2e7d32]">
    ...
    <Slide key="init">
      <h2 className="text-[#2a5298] text-[32px] md:text-[38px] font-bold mb-8 border-b-[3px] border-[#1e3c72] pb-3">🚀 理解 Zeabur 專案架構</h2>
      <p className="text-[20px] text-[#444] mb-6">當你部署 n8n 時，Zeabur 會自動建立兩個相互連結的服務：</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="bg-white p-6 rounded-2xl border-l-[6px] border-[#2a5298] shadow-md transform hover:scale-105 transition-all">
          ...
          <p className="text-[18px] text-[#555] mb-4">n8n 的資料庫，用來儲存：</p>
          <ul className="space-y-2 text-[16px] text-[#666]">
        ...
        <div className="bg-white p-6 rounded-2xl border-l-[6px] border-[#ff4081] shadow-md transform hover:scale-105 transition-all">
          ...
          <p className="text-[18px] text-[#555] mb-4">n8n 的主要服務，包含：</p>
          <ul className="space-y-2 text-[16px] text-[#666]">
            <li>✓ 網頁管理介面 (UI)</li>
            <li>✓ Workflow 執行引擎</li>
      ...
      <div className="bg-[#fff3cd] border border-[#ffc107] text-[#856404] p-5 rounded-xl flex items-start gap-3">
        ...
        <div>
          <strong className="block text-[18px] mb-1">等待初始化（可能顯示 UNKNOWN 狀態）</strong>
    ...
    <Slide key="troubleshooting">
      <h2 className="text-[#2a5298] text-[32px] md:text-[38px] font-bold mb-8 border-b-[3px] border-[#1e3c72] pb-3">🔧 Part 1 常見問題排解</h2>

      <div className="space-y-5">
        <div className="bg-white p-6 rounded-xl shadow-md border-l-4 border-red-500">
          <h3 className="text-[20px] font-bold text-red-600 mb-3">❌ 問題1：無法點擊「Create Project」或「Deploy」</h3>
          <p className="text-[16px] text-[#555] mb-2"><strong>原因：</strong>尚未完成手機驗證</p>
          <p className="text-[16px] text-green-700"><strong>解決：</strong>回到「帳戶設定」完成手機號碼驗證（詳見第 5 頁）</p>
        </div>

        <div className="bg-white p-6 rounded-xl shadow-md border-l-4 border-orange-500">
          <h3 className="text-[20px] font-bold text-orange-600 mb-3">⚠️ 問題2：收不到手機驗證碼</h3>
          ...
          <p className="text-[16px] text-green-700"><strong>解決：</strong>確認格式正確後，等待 1-2 分鐘。若仍未收到，可嘗試其他手機號碼</p>
        </div>

        <div className="bg-white p-6 rounded-xl shadow-md border-l-4 border-blue-500">
          <h3 className="text-[20px] font-bold text-blue-600 mb-3">💡 問題3：服務一直顯示 UNKNOWN 狀態</h3>
          <p className="text-[16px] text-[#555] mb-2"><strong>原因：</strong>服務正在初始化，需要時間</p>
          <p className="text-[16px] text-green-700"><strong>解決方法：</strong></p>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md border-l-4 border-purple-500">
          <h3 className="text-[20px] font-bold text-purple-600 mb-3">🔋 問題4：擔心免費額度用完</h3>
          <p className="text-[16px] text-[#555] mb-2"><strong>監控方式：</strong></p>
          <ul className="list-disc pl-6 space-y-1 text-[15px] text-[#666] mb-2">
            <li>在控制台右上角可看到當月用量</li>
            <li>點擊頭像 → Billing 可查看詳細帳單</li>
          </ul>
          <p className="text-[16px] text-green-700"><strong>省錢技巧：</strong>測試完成後，點擊服務進入詳細頁面，點擊右上角「...」→「Pause」暫停服務</p>
        </div>
      </div>
