  ...
  const slides = [
    ...
    <Slide key="cover">
      <div className="flex flex-col items-center justify-center h-full text-center">
        ...
        <h1 className="text-[#1e3c72] text-[40px] md:text-[56px] font-bold mb-6">Part 5: 實戰案例與延伸應用</h1>
        <h2 className="text-[#666] text-[24px] md:text-[28px] font-normal border-none max-w-[900px]">
          3 個超實用工作流模板，立即匯入使用！
        </h2>
        <div className="flex gap-6 mt-10">
          <span className="bg-gradient-to-r from-[#84fab0] to-[#8fd3f4] px-6 py-3 rounded-xl text-[#004d40] font-bold text-[18px] flex items-center gap-2">
            🌤️ 天氣查詢
          </span>
          <span className="bg-gradient-to-r from-[#ffecd2] to-[#fcb69f] px-6 py-3 rounded-xl text-[#8b4513] font-bold text-[18px] flex items-center gap-2">
            📰 RSS 爬蟲
          </span>
          <span className="bg-gradient-to-r from-[#a8edea] to-[#fed6e3] px-6 py-3 rounded-xl text-[#1e3c72] font-bold text-[18px] flex items-center gap-2">
            📊 每日摘要
          </span>
        </div>
      </div>
    ...
    // Slide 2: 下載模板
    <Slide key="download">
      <h2 className="text-[#2a5298] text-[32px] md:text-[38px] font-bold mb-8 border-b-[3px] border-[#1e3c72] pb-3">📥 步驟 1：下載工作流模板</h2>

      <div className="space-y-6">
        <div className="bg-gradient-to-r from-[#667eea]/10 to-[#764ba2]/10 p-6 rounded-2xl border-l-4 border-[#667eea]">
          <p className="text-[20px] text-[#333] leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-2xl border-2 border-[#06c755] shadow-lg hover:shadow-xl transition-shadow">
            <div className="text-center mb-4">
              ...
              <h3 className="text-[22px] font-bold text-[#1e3c72]">LINE 天氣查詢</h3>
            </div>
            <p className="text-[16px] text-[#666] mb-4 text-center">
          ...
          <div className="bg-white p-6 rounded-2xl border-2 border-[#ff6b35] shadow-lg hover:shadow-xl transition-shadow">
            <div className="text-center mb-4">
              ...
              <h3 className="text-[22px] font-bold text-[#1e3c72]">RSS 爬蟲</h3>
            </div>
            <p className="text-[16px] text-[#666] mb-4 text-center">
          ...
          <div className="bg-white p-6 rounded-2xl border-2 border-[#4facfe] shadow-lg hover:shadow-xl transition-shadow">
            <div className="text-center mb-4">
              <div className="text-[48px] mb-2">📊</div>
              <h3 className="text-[22px] font-bold text-[#1e3c72]">每日摘要</h3>
            </div>
            <p className="text-[16px] text-[#666] mb-4 text-center">
              整合多個來源<br/>每日自動推播摘要
            </p>
    ...
    // Slide 3: 匯入模板
    <Slide key="import">
      <h2 className="text-[#2a5298] text-[32px] md:text-[38px] font-bold mb-8 border-b-[3px] border-[#1e3c72] pb-3">📤 步驟 2：匯入模板到 n8n</h2>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-6">
          <div className="bg-[#f8f9fa] p-8 rounded-2xl border border-[#e9ecef] shadow-md">
            <h3 className="text-[24px] font-bold text-[#1e3c72] mb-6 flex items-center gap-2">
            ...
            <ol className="space-y-5 text-[18px]">
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-[16px] text-[#666] mt-1">登入你在 Zeabur 部署的 n8n</p>
                </div>
              </li>
              ...
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-[16px] text-[#666] mt-1">找到三個點的圖示</p>
                </div>
              </li>
              ...
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-[16px] text-[#666] mt-1">會跳出檔案選擇視窗</p>
                </div>
              </li>
              ...
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-[16px] text-[#666] mt-1">瀏覽並選取檔案</p>
                </div>
              </li>
              ...
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-[16px] text-[#666] mt-1">工作流會自動載入到畫布</p>
                </div>
              </li>
            </ol>
          </div>
        ...
        <div className="space-y-6">
          <div className="bg-[#e3f2fd] p-6 rounded-2xl border-l-4 border-[#2196f3]">
            <h3 className="text-[20px] font-bold text-[#1e3c72] mb-3 flex items-center gap-2">
              <AlertCircle size={24} /> 匯入後會看到什麼？
            </h3>
            <ul className="space-y-3 text-[17px] text-[#666]">
          ...
          <div className="bg-[#fff3cd] border border-[#ffc107] text-[#856404] p-5 rounded-xl">
            <strong className="block mb-2 text-[18px]">⚠️ 重要提醒</strong>
            <p className="text-[16px]">
          ...
          <div className="bg-[#e8f5e9] border-2 border-[#4caf50] text-[#2e7d32] p-5 rounded-xl">
            <strong className="flex items-center gap-2 text-[18px] mb-2">
    ...
    <Slide key="weather-intro">
      <div className="flex flex-col items-center justify-center h-full text-center">
        ...
        <h1 className="text-[#1e3c72] text-[40px] md:text-[52px] font-bold mb-6">模板 1：LINE 天氣查詢機器人</h1>
        <p className="text-[24px] text-[#666] max-w-[800px] mb-8">
          讓你的 LINE Bot 變成智慧氣象助手！<br/>
          輸入城市名稱，立即查詢台灣即時天氣
        </p>
        <div className="bg-gradient-to-r from-[#84fab0] to-[#8fd3f4] text-white px-8 py-4 rounded-2xl">
          <strong className="text-[22px]">🎯 學習目標</strong>
          <p className="mt-2 text-[18px]">城市辨識 + API 串接 + 動態回覆</p>
        </div>
      </div>
    </Slide>,
    ...
    <Slide key="weather-prep">
      <h2 className="text-[#2a5298] text-[32px] md:text-[38px] font-bold mb-8 border-b-[3px] border-[#1e3c72] pb-3">🌤️ 天氣機器人：事前準備</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#f8f9fa] p-6 rounded-2xl border border-[#e9ecef] shadow-md">
            ...
            <div className="space-y-4">
              <div className="bg-white p-5 rounded-xl border-l-4 border-[#06c755]">
                <h4 className="text-[20px] font-bold text-[#06c755] mb-2">1️⃣ LINE Messaging API</h4>
              ...
              <div className="bg-white p-5 rounded-xl border-l-4 border-[#4facfe]">
                <h4 className="text-[20px] font-bold text-[#4facfe] mb-2">2️⃣ OpenWeatherMap API</h4>
                <p className="text-[16px] text-[#666] mb-3">
                  免費方案，每日 1000 次呼叫
                </p>
                <ol className="text-[15px] space-y-2 text-[#666]">
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-[#667eea]/10 to-[#764ba2]/10 p-6 rounded-2xl border-l-4 border-[#667eea]">
            <h3 className="text-[22px] font-bold text-[#1e3c72] mb-4">🎯 這個模板做什麼？</h3>
            <ol className="space-y-3 text-[17px]">
          ...
          <div className="bg-[#e3f2fd] p-6 rounded-2xl border-l-4 border-[#2196f3]">
            <h3 className="text-[20px] font-bold text-[#1e3c72] mb-3">💬 使用範例</h3>
    ...
    <Slide key="weather-setup">
      <h2 className="text-[#2a5298] text-[32px] md:text-[38px] font-bold mb-8 border-b-[3px] border-[#1e3c72] pb-3">🌤️ 天氣機器人：詳細設定步驟</h2>
        ...
        <div className="bg-[#f8f9fa] p-8 rounded-2xl border border-[#e9ecef] shadow-md">
          ...
          <div className="space-y-5">
            <div className="bg-white p-6 rounded-xl border-l-4 border-[#06c755] shadow-sm">
              <h4 className="text-[20px] font-bold text-[#06c755] mb-4">步驟 1：設定 LINE Messaging 節點</h4>
              <ol className="space-y-3 text-[17px] text-[#666]">
                <li>
                  點擊「<strong>LINE Messaging Trigger</strong>」節點
                </li>
                <li>
                  在「Credential to connect with」選擇你的 LINE 憑證<br/>
                  <span className="text-[15px]">（Part 3 建立的 LINE Messaging account）</span>
                </li>
                <li>
            ...
            <div className="bg-white p-6 rounded-xl border-l-4 border-[#4facfe] shadow-sm">
              <h4 className="text-[20px] font-bold text-[#4facfe] mb-4">步驟 2：設定 OpenWeatherMap API</h4>
              <ol className="space-y-3 text-[17px] text-[#666]">
                <li>
                ...
                <li>
                  完整 URL 範例：<br/>
                  <code className="text-[14px] bg-gray-100 px-2 py-1 rounded inline-block mt-1">
            ...
            <div className="bg-white p-6 rounded-xl border-l-4 border-[#ff6b35] shadow-sm">
              <h4 className="text-[20px] font-bold text-[#ff6b35] mb-4">步驟 3：設定回覆訊息節點</h4>
    ...
    <Slide key="weather-test">
      <h2 className="text-[#2a5298] text-[32px] md:text-[38px] font-bold mb-8 border-b-[3px] border-[#1e3c72] pb-3">🌤️ 天氣機器人：測試與除錯</h2>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-6">
          <div className="bg-[#f8f9fa] p-6 rounded-2xl border border-[#e9ecef]">
            <h3 className="text-[22px] font-bold text-[#1e3c72] mb-4 flex items-center gap-2">
              <Smartphone className="text-[#06c755]" size={26} />
              測試步驟
            </h3>
            <ol className="space-y-3 text-[17px]">
              <li className="flex gap-2">
                <span className="bg-[#06c755] text-white w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 font-bold text-[15px]">1</span>
                <span>儲存工作流</span>
              </li>
              <li className="flex gap-2">
                <span className="bg-[#06c755] text-white w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 font-bold text-[15px]">2</span>
                <span>切換為「Active」啟用狀態</span>
              </li>
              <li className="flex gap-2">
                <span className="bg-[#06c755] text-white w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 font-bold text-[15px]">3</span>
                <span>打開 LINE，傳訊息給 Bot</span>
              </li>
              <li className="flex gap-2">
                <span className="bg-[#06c755] text-white w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 font-bold text-[15px]">4</span>
              ...
              <li className="flex gap-2">
                <span className="bg-[#06c755] text-white w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 font-bold text-[15px]">5</span>
          ...
          <div className="bg-[#e8f5e9] border-2 border-[#4caf50] text-[#2e7d32] p-5 rounded-xl">
            <strong className="flex items-center gap-2 text-[19px] mb-3">
        ...
        <div className="space-y-6">
          <div className="bg-[#ffebee] border-2 border-[#f44336] text-[#c62828] p-6 rounded-xl">
            <strong className="text-[20px] mb-4 block flex items-center gap-2">
          ...
          <div className="bg-[#e3f2fd] p-5 rounded-xl border-l-4 border-[#2196f3]">
            <strong className="text-[18px] text-[#1e3c72] mb-2 block">🔍 除錯技巧</strong>
    ...
    <Slide key="rss-intro">
      <div className="flex flex-col items-center justify-center h-full text-center">
        ...
        <h1 className="text-[#1e3c72] text-[40px] md:text-[52px] font-bold mb-6">模板 2：RSS 爬蟲工作流</h1>
        <p className="text-[24px] text-[#666] max-w-[800px] mb-8">
          自動訂閱你喜歡的網站 RSS<br/>
          定時抓取最新文章，推播到 LINE
        </p>
        <div className="bg-gradient-to-r from-[#ffecd2] to-[#fcb69f] text-[#8b4513] px-8 py-4 rounded-2xl">
          <strong className="text-[22px]">🎯 學習目標</strong>
          <p className="mt-2 text-[18px]">RSS 訂閱 + 定時執行 + 資料過濾</p>
        </div>
      </div>
    </Slide>,
    ...
    // 繼續 RSS 爬蟲的詳細教學...
    <Slide key="rss-prep">
      <h2 className="text-[#2a5298] text-[32px] md:text-[38px] font-bold mb-8 border-b-[3px] border-[#1e3c72] pb-3">📰 RSS 爬蟲：事前準備</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#f8f9fa] p-6 rounded-2xl border border-[#e9ecef] shadow-md">
            ...
            <div className="space-y-4">
              <div className="bg-white p-5 rounded-xl border-l-4 border-[#ff6b35]">
                <h4 className="text-[20px] font-bold text-[#ff6b35] mb-2">1️⃣ RSS 摘要網址</h4>
                <p className="text-[16px] text-[#666] mb-3">
                  找到你想訂閱的網站 RSS 網址
                </p>
                <div className="text-[15px] space-y-2 text-[#666]">
                  <p><strong>範例：</strong></p>
                  <ul className="space-y-1 ml-4">
                    <li>• TechCrunch: <code className="text-[13px]">feeds.feedburner.com/TechCrunch</code></li>
                    <li>• Hacker News: <code className="text-[13px]">news.ycombinator.com/rss</code></li>
                    <li>• 科技新報: <code className="text-[13px]">technews.tw/feed</code></li>
                  </ul>
                </div>
              </div>

              <div className="bg-white p-5 rounded-xl border-l-4 border-[#06c755]">
                <h4 className="text-[20px] font-bold text-[#06c755] mb-2">2️⃣ LINE Messaging API</h4>
                <p className="text-[16px] text-[#666]">
                  ✅ 使用 Part 3 建立的憑證<br/>
                  用來推播文章更新通知
                </p>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#e3f2fd] p-6 rounded-2xl border-l-4 border-[#2196f3]">
            <h3 className="text-[20px] font-bold text-[#1e3c72] mb-3">💬 推播範例</h3>
            <div className="bg-white p-4 rounded-lg text-[16px]">
              <div className="text-[#667eea] font-bold mb-2">📰 科技新聞更新</div>
              <div className="text-[#333]">
                <strong>AI 技術新突破</strong><br/>
                OpenAI 發布最新模型...<br/>
                <a href="#" className="text-blue-600 text-[14px]">閱讀全文 →</a>
              </div>
            </div>
          </div>
    ...
    // RSS 設定步驟...
    <Slide key="rss-setup">
      <h2 className="text-[#2a5298] text-[32px] md:text-[38px] font-bold mb-8 border-b-[3px] border-[#1e3c72] pb-3">📰 RSS 爬蟲：詳細設定步驟</h2>
        ...
        <div className="bg-[#f8f9fa] p-8 rounded-2xl border border-[#e9ecef] shadow-md">
          ...
          <div className="space-y-5">
            <div className="bg-white p-6 rounded-xl border-l-4 border-[#667eea] shadow-sm">
              <h4 className="text-[20px] font-bold text-[#667eea] mb-4">步驟 1：設定定時器（Schedule Trigger）</h4>
              <ol className="space-y-3 text-[17px] text-[#666]">
                <li>
                ...
                <li>
                  設定執行頻率：
                  <ul className="ml-6 mt-2 space-y-1 text-[16px]">
            ...
            <div className="bg-white p-6 rounded-xl border-l-4 border-[#ff6b35] shadow-sm">
              <h4 className="text-[20px] font-bold text-[#ff6b35] mb-4">步驟 2：設定 RSS Feed 節點</h4>
              <ol className="space-y-3 text-[17px] text-[#666]">
                <li>
                ...
                <li>
                  ...
                  <span className="text-[15px]">例如：<code>https://technews.tw/feed</code></span>
                </li>
                <li>
                  設定「Max Items」（最多讀取幾篇）<br/>
                  <span className="text-[15px]">建議設為 <code>5</code> 或 <code>10</code></span>
                </li>
              </ol>
            </div>

            <div className="bg-white p-6 rounded-xl border-l-4 border-[#06c755] shadow-sm">
              <h4 className="text-[20px] font-bold text-[#06c755] mb-4">步驟 3：設定 LINE 推播節點</h4>
              <ol className="space-y-3 text-[17px] text-[#666]">
                <li>
                ...
                <li>
                  ...
                  <span className="text-[15px]">（可在 LINE Developers Console 測試訊息處找到）</span>
                </li>
                <li>
                  訊息格式已預設好，會自動顯示：<br/>
                  • 文章標題<br/>
    ...
    <Slide key="summary-intro">
      <div className="flex flex-col items-center justify-center h-full text-center">
        <div className="text-[100px] mb-6">📊</div>
        <h1 className="text-[#1e3c72] text-[40px] md:text-[52px] font-bold mb-6">模板 3：每日摘要工作流</h1>
        <p className="text-[24px] text-[#666] max-w-[800px] mb-8">
          整合多個資料來源<br/>
          每天早上自動推播今日重點摘要
        </p>
        <div className="bg-gradient-to-r from-[#a8edea] to-[#fed6e3] text-[#1e3c72] px-8 py-4 rounded-2xl">
          <strong className="text-[22px]">🎯 學習目標</strong>
          <p className="mt-2 text-[18px]">多來源整合 + 定時推播 + 格式化</p>
        </div>
      </div>
    </Slide>,
    ...
    <Slide key="summary-prep">
      <h2 className="text-[#2a5298] text-[32px] md:text-[38px] font-bold mb-8 border-b-[3px] border-[#1e3c72] pb-3">📊 每日摘要：事前準備</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-6">
          <div className="bg-[#f8f9fa] p-6 rounded-2xl border border-[#e9ecef] shadow-md">
            ...
            <div className="space-y-4 text-[16px]">
              <div className="bg-white p-5 rounded-xl border-l-4 border-[#4facfe]">
                <h4 className="text-[19px] font-bold text-[#4facfe] mb-2">1️⃣ 天氣 API</h4>
                <p className="text-[#666]">OpenWeatherMap（模板1 使用的）</p>
              </div>

              <div className="bg-white p-5 rounded-xl border-l-4 border-[#ff6b35]">
                <h4 className="text-[19px] font-bold text-[#ff6b35] mb-2">2️⃣ 新聞 API（選用）</h4>
                <p className="text-[#666]">NewsAPI.org 或使用 RSS</p>
              </div>

              <div className="bg-white p-5 rounded-xl border-l-4 border-[#06c755]">
                <h4 className="text-[19px] font-bold text-[#06c755] mb-2">3️⃣ LINE Messaging API</h4>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#e3f2fd] p-6 rounded-2xl border-l-4 border-[#2196f3]">
            <h3 className="text-[20px] font-bold text-[#1e3c72] mb-3">💬 摘要範例</h3>
            <div className="bg-white p-4 rounded-lg text-[15px]">
    ...
    <Slide key="summary-setup">
      <h2 className="text-[#2a5298] text-[32px] md:text-[38px] font-bold mb-8 border-b-[3px] border-[#1e3c72] pb-3">📊 每日摘要：詳細設定步驟</h2>
      ...
      <div className="space-y-6">
        <div className="bg-[#f8f9fa] p-8 rounded-2xl border border-[#e9ecef] shadow-md">
          ...
          <div className="space-y-5">
            <div className="bg-white p-6 rounded-xl border-l-4 border-[#667eea] shadow-sm">
              <h4 className="text-[20px] font-bold text-[#667eea] mb-4">步驟 1：設定每日定時</h4>
              <ol className="space-y-3 text-[17px] text-[#666]">
                <li>
                  點擊「<strong>Schedule Trigger</strong>」節點
                </li>
                ...
                <li>
                  ...
                  <span className="text-[15px]">（代表每天早上 8:00）</span>
                </li>
                <li>
                  💡 可以改成你想要的時間，例如：<br/>
            ...
            <div className="bg-white p-6 rounded-xl border-l-4 border-[#4facfe] shadow-sm">
              <h4 className="text-[20px] font-bold text-[#4facfe] mb-4">步驟 2：設定各個資料來源</h4>
              <div className="space-y-4 text-[16px] text-[#666]">
                <div>
            ...
            <div className="bg-white p-6 rounded-xl border-l-4 border-[#06c755] shadow-sm">
              <h4 className="text-[20px] font-bold text-[#06c755] mb-4">步驟 3：設定推播與格式</h4>
              <ol className="space-y-3 text-[17px] text-[#666]">
                <li>
                  找到「<strong>Function</strong>」節點（整合資料用）<br/>
                  <span className="text-[15px]">這個節點會把所有資料整合成一則訊息</span>
                </li>
                <li>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-[#e8f5e9] border border-[#4caf50] text-[#2e7d32] p-4 rounded-xl">
            ...
            <p className="text-[15px]">先改成每分鐘執行，測試成功後再改回每日</p>
          </div>
          <div className="bg-[#fff3cd] border border-[#ffc107] text-[#856404] p-4 rounded-xl">
            ...
            <p className="text-[15px]">可以依需求增減資料來源</p>
          </div>
        </div>
      </div>
    </Slide>,
    ...
    <Slide key="conclusion">
      <div className="flex flex-col items-center justify-center h-full text-center px-6">
        <div className="text-[100px] mb-6">🎉</div>
        <h1 className="text-[#1e3c72] text-[40px] md:text-[52px] font-bold mb-6">恭喜完成 Part 5！</h1>
        <p className="text-[24px] text-[#666] mb-8 max-w-[900px]">
          你已經學會使用 3 個實戰工作流模板：
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-[1000px] mb-10">
          <div className="bg-gradient-to-br from-[#84fab0] to-[#8fd3f4] p-6 rounded-2xl text-[#004d40]">
            <div className="text-[48px] mb-2">🌤️</div>
            <h3 className="text-[20px] font-bold mb-2">天氣查詢</h3>
            <p className="text-[16px]">智慧辨識城市<br/>即時天氣回覆</p>
          </div>

          <div className="bg-gradient-to-br from-[#ffecd2] to-[#fcb69f] p-6 rounded-2xl text-[#8b4513]">
            <div className="text-[48px] mb-2">📰</div>
            <h3 className="text-[20px] font-bold mb-2">RSS 爬蟲</h3>
            <p className="text-[16px]">自動訂閱<br/>定時推播</p>
          </div>

          <div className="bg-gradient-to-br from-[#a8edea] to-[#fed6e3] p-6 rounded-2xl text-[#1e3c72]">
            <div className="text-[48px] mb-2">📊</div>
            <h3 className="text-[20px] font-bold mb-2">每日摘要</h3>
            <p className="text-[16px]">多來源整合<br/>定時摘要</p>
          </div>
        </div>

        <div className="bg-gradient-to-r from-[#667eea] to-[#764ba2] text-white px-10 py-6 rounded-2xl text-[20px] font-semibold shadow-2xl">
          🚀 現在你可以開始客製化自己的工作流了！
        </div>

        <div className="mt-8 text-[18px] text-[#666] max-w-[700px]">
